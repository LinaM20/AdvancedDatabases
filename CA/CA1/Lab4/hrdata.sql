...
/* Data for job history */
insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc, enddate) values
(200, '1987-09-17', 3, 2000.00, 2, 'Starting Position', '1998-09-16');
insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc) values
(200, '1988-09-17', 3, 2000.00, 1, 'Promotion');

insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc, enddate) values
(201, '1996-02-17', 3, 4000.00, 1, 'Starting Position', '2000-09-16');
insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc) values
(200, '2000-09-17', 10, 20000.00,2 , 'Promotion');

insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc, enddate) values
(116, '1997-12-24', 1, 2000.00, 1, 'Starting Position', '1998-09-16');
insert into jobhist (employee_id, startdate, job_id, salary, department_id, changedesc) values
(116, '1998-09-17', 13, 5000.00,3 , 'Promotion');
